...
export default function GarbageReport() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:5000/api/garbageReport",
        data
      );
      console.log("Response:", res.data);
      alert("✅ Garbage report submitted!");
      setFormData({ reporterName: "", description: "", location: "" });
      setImage(null);
    } catch (err) {
      console.error("Error:", err);
      alert("❌ Error submitting garbage report.");
    }
  };
  ...
  return (
    ...
    >
      <div className="bg-white bg-opacity-90 p-8 rounded-2xl shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 text-center">🗑️ Garbage Report</h2>
